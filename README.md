...
[![Descargar POS Windows](https://img.shields.io/badge/Descargar-POS%20Windows%20.exe-1F9D55?logo=windows&logoColor=white)](https://github.com/xavisystem4-lab/hangar421/releases/tag/v0.2.50)
...
- **POS Windows**: [descargar `.exe`](https://github.com/xavisystem4-lab/hangar421/releases/tag/v0.2.50)
