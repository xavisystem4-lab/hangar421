/** Gráfica de barras minimalista en SVG puro (sin dependencias externas), pensada para
 *  "ventas por hora" en el dashboard. Ver skill dataviz para lineamientos de color/forma. */
