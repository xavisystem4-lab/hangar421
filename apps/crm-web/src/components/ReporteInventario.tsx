 ...
 *  cambiar de página) y exportación real a PDF/Excel + impresión — antes "Generar Reporte" solo
 *  bajaba un CSV sin vista previa ni otros formatos. Mismo componente en pos-desktop, salvo cómo
 *  se guarda el archivo (aquí, File System Access API del navegador; allá, diálogo nativo de
 *  Electron — ver AdminInventario.tsx). */
