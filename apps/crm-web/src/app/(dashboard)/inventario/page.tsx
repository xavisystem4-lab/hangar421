              ...
              return (
                <tr key={i.id} style={{ borderBottom: "1px solid var(--h421-gray-200)" }}>
                  ...
                  <td style={{ padding: 8, display: "flex", gap: 6 }}>
                    ...
                    <button onClick={() => eliminarInsumo(i)} style={{ background: "#fee2e2", color: "var(--h421-red)", padding: "4px 10px", fontSize: 12 }}>Eliminar</button>
                  </td>
                </tr>
              );
            })}
        ...
        <div className="card">
          ...
          {proveedores.map((p) => (
            <div key={p.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "6px 0", borderBottom: "1px solid var(--h421-gray-200)", fontSize: 14 }}>
              ...
              <button onClick={() => eliminarProveedor(p)} style={{ background: "#fee2e2", color: "var(--h421-red)", padding: "4px 8px", fontSize: 12 }}>Eliminar</button>
            </div>
          ))}
